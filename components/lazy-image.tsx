...
export default function LazyImage({
  ...
  // Generate blur placeholder if not provided - use a simple data URI instead of a blob URL
  ...
  const imageBlurDataURL = blurDataURL || defaultBlurDataURL
  const imagePlaceholder = placeholder || "blur"
