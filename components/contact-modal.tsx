...
import { Mail, Linkedin, Github, Twitter, X, Phone } from "lucide-react";
...
export default function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[550px] max-w-[95vw] bg-black/90 backdrop-blur-lg border-white/10 p-0 overflow-hidden">
        ...
        <div className="px-4 sm:px-6">
          <div className="mb-4 sm:mb-6">
            <a
              ...
              className="group block bg-[#0f1729] hover:bg-[#162033] p-4 sm:p-6 rounded-lg transition-colors"
            >
              ...
              <p className="text-sm sm:text-base text-white font-medium mb-1 break-all">
                {emailAddress}
              </p>
          ...
          <div className="mb-4 sm:mb-6">
            <div className="group block bg-[#291f0f] hover:bg-[#332710] p-4 sm:p-6 rounded-lg transition-colors">
              <div className="flex items-center mb-3 sm:mb-4">
        ...
        <div className="px-4 sm:px-6 pb-4 sm:pb-6">
          <div className="flex items-center justify-center p-2.5 sm:p-3 bg-[#0f291f] rounded-lg">
